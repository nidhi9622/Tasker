...
@override
                  ...
                  children: [
                    Padding(
                      ...
                      child: DefaultTabController(
                        ...
                        child: Builder(
                            builder: (context) {
                              final TabController tabController = DefaultTabController
                                  .of(context)!;
                              ...
                              return Container(height: 65, width: deviceSize.width,
                                ...
                                child: TabBar(
                                    ...
                                    unselectedLabelColor: Colors
                                        .red[200] //const Color(0xffffb2a6),
                                ),);
                            }
                        ),
                      ),
                    ...
                    if(displayIndex == 0)
                      tabView(deviceSize, projectItem),
                    if(displayIndex == 1)
                      tabView(deviceSize, ongoingProjects),
                    if(displayIndex == 2)
                      tabView(deviceSize, completedProjects)
                  ],
                ),
              ),
        );
    ...
    showModalBottomSheet(elevation: 3,
        ...
        context: context, builder: (BuildContext context) {
          return Padding(
            ...
            child: SizedBox(height: deviceSize.height * 0.20,
                child: Column(
                  children: [
                    InkWell(
                      onTap: () {
                      ...
                      child: ListTile(title: const Text('Edit'),
  ...
  tabView(dynamic deviceSize, List tabList) {
    return Container(height: deviceSize.height * 0.69,
      padding: const EdgeInsets.only(left: 14, right: 14),
      child: tabList.isNotEmpty ? ListView.builder(
          itemCount: tabList.length, itemBuilder: (context, index) {
        DataModel dataModel = DataModel(tabList[index]);
        return Padding(
          padding: const EdgeInsets.only(bottom: 12),
          child: InkWell(onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => ProjectDetail(object: tabList[index])));
          },
            onLongPress: () {
                ...
                children: [
                  SizedBox(width: deviceSize.width * 0.60,
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(dataModel.title!, style: const TextStyle(
        ...
        children: [
          Text('noTask'.tr, style: const TextStyle(fontWeight: FontWeight.bold,
              fontSize: 22,

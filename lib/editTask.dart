...
class EditTask extends StatefulWidget {
  Map object;
  EditTask({Key? key,required this.object}) : super(key: key);

  @override
  State<EditTask> createState() => _EditTaskState(object: object);
}
int newId=0;
class _EditTaskState extends State<EditTask> {
  ...
  Map object;dynamic status;bool preExist=false;Map map={};
    ...
    switch(dropDown1){
      ...
      case 1:{
        List list=[];
          ...
          String? string=preferences.getString('${object['title']}');
          ...
          setState(() {
            ...
            preferences.setString('completedProjects', jsonEncode(completedProjects));
            preferences.setString('ongoingProjects', jsonEncode(ongoingProjects));
            preferences.setString('${object['title']}', jsonEncode(list));
            preferences.setString('projects', jsonEncode(optionList));
          });}break;
      case 2:{
          upcomingProjects.removeWhere((element) => element['title'] == dataModel.title);
  ...
  _EditTaskState({required this.object});
  @override

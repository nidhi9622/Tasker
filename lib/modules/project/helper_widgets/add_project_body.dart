            ...
            children: [
              ...
              DateTimeWidget(
                  onTap: () async {
                    ...
                    if (picked != null && picked != widget.controller.selectedDate.value) {
                        widget.controller.selectedDate.value = picked;
                    }
                  },
                  text: DateFormat("MMM dd, yyyy").format(widget.controller.selectedDate.value),
                  isDate: true),
              HeadingText(text: 'startTime'.tr),
              DateTimeWidget(
                  onTap: () async {
                    final picked = await selectTime(context);
                    if (picked != null && picked != widget.controller.selectedTime.value) {
              ...
              HideContainer(
                  onTap: () {
                    widget.controller.descriptionHeight.value = 60;
                  },
                  text: 'description'.tr),
              ...
              TaskBodyBottom(
                reminder:widget.controller.reminder.value,
                percentageController: widget.controller.percentageController.value,
                dropDownValue: widget.controller.dropDownValue.value,
              ),
            ],
          );
        }
